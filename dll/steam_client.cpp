...
Steam_Client::Steam_Client()
{
    ...
    steam_timeline = new Steam_Timeline(settings_client, callback_results_client);
    steam_gamestats = new Steam_GameStats(settings_client, callback_results_client);
    steam_appticket = new Steam_AppTicket(settings_client);
    ...
    steam_networking_sockets->set_messages_layer(steam_networking_messages);
    steam_gameserver_networking_sockets->set_messages_layer(steam_gameserver_networking_messages);
...
Steam_Client::~Steam_Client()
{
    ...
    delete steam_gamestats;
    delete steam_appticket;
...
ISteamFriends *Steam_Client::GetISteamFriends( HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion )
{
    ...
    if (strcmp(pchVersion, "SteamFriends003") == 0) {
        ...
        return (ISteamFriends *)(void *)(ISteamFriends017 *)steam_friends;
    } else {
        return (ISteamFriends *)(void *)(ISteamFriends *)steam_friends;
    }
...
void *Steam_Client::GetISteamGenericInterface( HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion )
{
    ...
    if (strstr(pchVersion, "SteamNetworkingSocketsSerialized") == pchVersion) {
        ...
        if (strcmp(pchVersion, "SteamNetworkingSockets001") == 0) {
            ...
            return (void *)(ISteamNetworkingSockets012 *) steam_networking_sockets_temp;
        } else {
    ...
    } else if (strcmp(pchVersion, "STEAMTIMELINE_INTERFACE_V001") == 0) {
        return (void *)(ISteamTimeline001 *)steam_timeline;
        ...
        return (void *)(ISteamAppTicket *)steam_appticket;
    } else if (strcmp(pchVersion, "SteamGameStats001") == 0) {
        return (void *)(ISteamGameStats *)steam_gamestats;
    } else if (strcmp(pchVersion, "SteamClient007") == 0) {
        return (void *)(ISteamClient007 *)this;
    } else if (strcmp(pchVersion, "SteamClient008") == 0) {
        return (void *)(ISteamClient008 *)this;
    } else if (strcmp(pchVersion, "SteamClient009") == 0) {
        return (void *)(ISteamClient009 *)this;
    } else if (strcmp(pchVersion, "SteamClient010") == 0) {
        return (void *)(ISteamClient010 *)this;
    } else if (strcmp(pchVersion, "SteamClient011") == 0) {
        return (void *)(ISteamClient011 *)this;
    } else if (strcmp(pchVersion, "SteamClient012") == 0) {
        return (void *)(ISteamClient012 *)this;
    } else if (strcmp(pchVersion, "SteamClient013") == 0) {
        return (void *)(ISteamClient013 *)this;
    } else if (strcmp(pchVersion, "SteamClient014") == 0) {
        return (void *)(ISteamClient014 *)this;
    } else if (strcmp(pchVersion, "SteamClient015") == 0) {
        return (void *)(ISteamClient015 *)this;
    } else if (strcmp(pchVersion, "SteamClient016") == 0) {
        return (void *)(ISteamClient016 *)this;
    } else if (strcmp(pchVersion, "SteamClient017") == 0) {
        return (void *)(ISteamClient017 *)this;
    } else if (strcmp(pchVersion, "SteamClient018") == 0) {
        return (void *)(ISteamClient018 *)this;
    } else if (strcmp(pchVersion, "SteamClient019") == 0) {
        return (void *)(ISteamClient019 *)this;
    } else if (strcmp(pchVersion, "SteamClient020") == 0) {
        return (void *)(ISteamClient020 *)this;
    } else if (strcmp(pchVersion, "SteamClient021") == 0) {
        return (void *)(ISteamClient021 *)this;
    } else if (strcmp(pchVersion, "SteamClient023") == 0) {
        return (void *)(ISteamClient *)this;
...
ISteamUserStats *Steam_Client::GetISteamUserStats( HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion )
{
    ...
    if (strcmp(pchVersion, "STEAMUSERSTATS_INTERFACE_VERSION001") == 0) {
        ...
        return (ISteamUserStats *)(void *)(ISteamUserStats012 *)steam_user_stats;
...
ISteamController *Steam_Client::GetISteamController( HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion )
{
    ...
    if (strcmp(pchVersion, "STEAMCONTROLLER_INTERFACE_VERSION") == 0) {
        ...
        return (ISteamController *)(void *)(ISteamController_v008_shim *)steam_controller;
    } else {
        return (ISteamController *)(void *)(ISteamController_v008_shim *)steam_controller;
    }
...
ISteamUGC *Steam_Client::GetISteamUGC( HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion )
{
    ...
    if (strcmp(pchVersion, "STEAMUGC_INTERFACE_VERSION") == 0) {
        ...
        return (ISteamUGC *)(void *)(ISteamUGC018 *)steam_ugc_temp;
    } else if (strcmp(pchVersion, "STEAMUGC_INTERFACE_VERSION020") == 0) {
        return (ISteamUGC *)(void *)(ISteamUGC020 *)steam_ugc_temp;
    } else if (strcmp(pchVersion, "STEAMUGC_INTERFACE_VERSION016") == 0) {
        return (ISteamUGC *)(void *)(ISteamUGC016 *)steam_ugc_temp;
...
ISteamRemotePlay *Steam_Client::GetISteamRemotePlay( HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion )
{
    ...
    if (strcmp(pchVersion, "STEAMREMOTEPLAY_INTERFACE_VERSION001") == 0) {
        ...
        return (ISteamRemotePlay *)(void *)(ISteamRemotePlay002 *)steam_remoteplay;
    } else if (strcmp(pchVersion, "STEAMREMOTEPLAY_INTERFACE_VERSION003") == 0) {
        return (ISteamRemotePlay *)(void *)(ISteamRemotePlay003 *)steam_remoteplay;
    }
